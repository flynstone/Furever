...
namespace Furever.Client.Handlers
{
    public class BearerTokenHandler : DelegatingHandler
    {
        ...
        private static List<AuthenticationToken> GetUpdatedTokens(TokenResponse refreshResponse)
        {
            List<AuthenticationToken> updatedTokens = new()
            {
